    ...
    public void saveChanges(){
        btnChangePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //check password
                if(!account.getPassword().equals(currentPassword)&& currentPassword.length()>0){
                ...
                if(StrongPassword(newPassword)==false && newPassword.length()>0){
